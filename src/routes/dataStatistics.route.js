...
route.get('/order', authenticateUser, authorizePermissions('vendor', 'admin'), statisticsApi.orderStat);
route.get('/review', authenticateUser, authorizePermissions('vendor', 'admin'), statisticsApi.reviewStat);
